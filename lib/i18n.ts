...
export const dict: Record<Locale, Dict> = {
  fr: {
    ...
    reviews: {
      ...
      sub: "Porté par les hommes qui font la différence.",
      items: [
        { name: "Hamza", city: "", quote: "Enfin essayer le MYSLF de Yves Saint Laurent sans flipper sur le prix. Le décant tient une journée entière. J'ai déjà recommandé le Signature." },
        { name: "Mehdi", city: "", quote: "Le packaging est sérieux, les parfums authentiques. Livré en 36 heures. Je change de signature selon l'occasion." },
        { name: "Youssef", city: "", quote: "Scent of Kings tient ses promesses. Le bundle Royal est un autre niveau — des regards dès le premier porté." },
        { name: "Karim", city: "", quote: "Les 10 ml durent un bon mois en porté quotidien. Bien plus malin que de claquer 1 800 DH sur un flacon qu'on n'aime plus." },
      ],
    },
    faq: {
    ...
    story: {
      ...
      body: "Scent of Kings est né d'une obsession simple : un grand parfum ne devrait pas être un luxe réservé à quelques-uns. Alors on décante. À la main, dans des flacons pharmaceutiques de qualité, à partir de bouteilles 100% authentiques. Vous portez le même parfum — vous payez ce qui est juste.",
      line1Label: "Senteurs disponibles",
      line1Value: "10+",
  ...
  en: {
    ...
    reviews: {
      ...
      sub: "Worn by men who know the difference.",
      items: [
        { name: "Hamza", city: "", quote: "Finally got to try YSL MYSLF without sweating over the price. The decant lasts a full day. Already reordered the Signature." },
        { name: "Mehdi", city: "", quote: "Packaging is serious, fragrances are authentic. Delivered in 36 hours. I switch signatures by the occasion now." },
        { name: "Youssef", city: "", quote: "Scent of Kings delivers exactly what it promises. Royal bundle is next level — turned heads on the first wear." },
        { name: "Karim", city: "", quote: "10 ml lasts me a solid month of daily wear. Way smarter than blowing 1,800 DH on a bottle you'll get tired of." },
      ],
    },
    faq: {
    ...
    story: {
      ...
      body: "Scent of Kings was born from a simple obsession: great fragrance should not be a luxury reserved for a few. So we decant. By hand, into premium pharma glass, from 100% authentic bottles. Same fragrance — fair price.",
      line1Label: "Scents curated",
      line1Value: "10+",
